...
if (QT_STATIC_BUILD)
    ...
    list(APPEND EXTRA_LIBS_NAMES png)
    list(APPEND EXTRA_LIBS_NAMES jpeg)
    if (WEBKIT_PKGCONGIG_DEPS MATCHES "[ ]*Qt5Sql[ ]*")
        list(APPEND EXTRA_LIBS_NAMES Qt5Sql)
    endif()
    if (QT_BUNDLED_PNG OR QT_BUNDLED_JPEG)
        list(APPEND EXTRA_LIBS_NAMES Qt5Gui)
    endif ()
    foreach (LIB_NAME ${EXTRA_LIBS_NAMES})
        set(WEBKIT_PKGCONGIG_DEPS "${WEBKIT_PKGCONGIG_DEPS} ${LIB_PREFIX}${LIB_NAME}")
        if (APPLE AND (LIB_NAME MATCHES "png" OR LIB_NAME MATCHES "jpeg"))
            set(LIB_LOCATION "-L/usr/local/lib ")
        else ()
            set(LIB_LOCATION "")
        endif ()
        set(WEBKIT_PRI_EXTRA_LIBS "${WEBKIT_PRI_EXTRA_LIBS} ${LIB_LOCATION}-l${LIB_PREFIX}${LIB_NAME}")
    endforeach ()
else ()
