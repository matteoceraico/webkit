...
if (SQLITE3_SOURCE_DIR)
    ...
    add_library(SQLITE_LIBRARIES STATIC ${SQLITE_SOURCE_FILE})
    target_compile_definitions(SQLITE_LIBRARIES PUBLIC -DSQLITE_CORE -DSQLITE_OMIT_LOAD_EXTENSION -DSQLITE_OMIT_COMPLETE)
    WEBKIT_SET_EXTRA_COMPILER_FLAGS(SQLITE_LIBRARIES)
    set(SQLITE_FOUND 1)
else ()
